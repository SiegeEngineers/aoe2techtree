...
const HOUFNICE = 1709;
const FOLWARK = 1734;
const RATHA_MELEE = 1738;
const ELITE_RATHA_MELEE = 1740;
...
function getDefaultTree() {
    ...
    krepostlane.rows.castle_2.push(uniqueunit(DISMOUNTED_KONNIK));
    krepostlane.rows.castle_2.push(uniqueunit(KONNIK_2));
    krepostlane.rows.castle_2.push(uniqueunit(RATHA_MELEE));
    krepostlane.rows.imperial_1.push(uniqueunit(DISMOUNTED_ELITE_KONNIK));
    krepostlane.rows.imperial_1.push(uniqueunit(ELITE_KONNIK_2));
    krepostlane.rows.imperial_1.push(uniqueunit(ELITE_RATHA_MELEE));
...
function getConnections() {
    let connections = [
        ...
        [u(DISMOUNTED_KONNIK), u(DISMOUNTED_ELITE_KONNIK)],
        [u(KONNIK_2), u(ELITE_KONNIK_2)],
        [u(RATHA_MELEE), u(ELITE_RATHA_MELEE)],
