var TYPES = Object.freeze({
    "BUILDING": {colour: '#922602', type: 'BUILDING', name: 'Building', dataType: 'buildings'},
    "UNIT": {colour: '#3a6a80', type: 'UNIT', name: 'Unit', dataType: 'units'},
    "UNIQUEUNIT": {colour: '#af30a3', type: 'UNIQUEUNIT', name: 'Unique Unit', dataType: 'units'},
    "TECHNOLOGY": {colour: '#2c5729', type: 'TECHNOLOGY', name: 'Technology', dataType: 'techs'}
});
