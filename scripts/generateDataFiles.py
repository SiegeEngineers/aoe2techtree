...
def main():
    ...
    with datafile.open('w') as f:
        ...
        json.dump({"tech_tree_strings": TECH_TREE_STRINGS, "age_names": AGE_NAMES, "civ_names": CIV_NAMES, "civ_helptexts": CIV_HELPTEXTS, "data": data}, f, indent=4, sort_keys=True,
                  ensure_ascii=False)
